...
if __name__ == "__main__":
    ...
    model_p = NN_TL_Diffusion(general_layers=[64, 64, 64, 64], fine_layers=[32, 32], dim_in=3, dim_int=32,
                              dim_out=1, dropout=0.)
    model = Electrolyte(model_p, parameters, [1., 1., 1.], criterion=RMSELoss, electrode="pos", weights=pos_weights, adjustable_weights=False)
    optimizer = NTK_Adaptive(model.model.parameters(), model.weigths)
