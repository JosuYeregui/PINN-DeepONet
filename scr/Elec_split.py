...
class Electrolyte_Split(nn.Module):
    ...
    def __init__(self, weights, criterion=nn.MSELoss()):
        super().__init__()

        self.params_p = {"I_typ": 5., "L": 7.56e-05, "F": 96485.33212, "t_plus": 0.2594, "ce0": 1000.,
                    "D": 1.7694e-10, "brug": 1.5, "por": 0.335, "tc": 3600., "A": 0.10270000000000001, "L_tot": 0.0001728}
        ...
        self.params_s = {"I_typ": 5., "L": 1.2e-05, "F": 96485.33212, "t_plus": 0.2594, "ce0": 1000.,
                    "D": 1.7694e-10, "brug": 1.5, "por": 0.47, "tc": 3600., "A": 0.10270000000000001, "L_tot": 0.0001728}
    ...
    def compute_loss(self, data, data_bc0, data_bc1):
        ...
        #    loss_pde += self.criterion(self._pde(data, c, param, electrode=e), torch.zeros_like(c))
        loss_pde = self.criterion(self._pde(data, neg_c, self.params_n, electrode="negative"), torch.zeros_like(neg_c))
        ...
        _, _, pos_c_bc1 = self.predict(data_bc1, data_bc1)
    ...
    def _pde(self, x, c, param, electrode="positive"):
        ...
        De_eff = torch.ones_like(c) * param["D"] * param["por"] ** param["brug"]
